...
<label for="${AttributeConst.REP_CONTNET.getValue()}">内容</label>
<textarea name="${AttributeConst.REP_COUNT.getValue()}" id="${AttributeConst.REP_CONTENT.getValue()}" rows="10" cols="50">${report.content}</textarea>
<br /> <br />
